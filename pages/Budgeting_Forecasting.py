...
def render():
    ...
    if raw_df is not None and not raw_df.empty:
        ...
        with col1:
            ...
            st.markdown(
                "**Purpose:** Track department spending patterns and forecast future expenses using 12-month historical data.<br/>**Insight:** Compare spending trends across departments and predict budget requirements for better resource allocation.",
                unsafe_allow_html=True,
            )
