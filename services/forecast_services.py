...
class ForecastPreviewService:
    ...
    def get_cash_flow_forecast_preview(self) -> Dict:
        ...
        try:
            ...
            best_case_runway = (
                current_cash / best_case_burn if best_case_burn > 0 else 0
            )
            worst_case_runway = (
                current_cash / worst_case_burn if worst_case_burn > 0 else 0
            )
            ...
            return {
                ...
                "burn_volatility": (
                    (burn_std / avg_monthly_burn) * 100 if avg_monthly_burn > 0 else 0
                ),
            }
        except Exception as e:
            return {"error": str(e)}
