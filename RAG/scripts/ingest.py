...
if __name__ == "__main__":
    # Ingest AP Invoice
    ap_invoice_path = "RAG/data/AP_Invoice.csv"
    ...
    # Ingest AR Invoice
    ar_invoice_path = "RAG/data/AR_Invoice.csv"
    ...
    regulations_path = "RAG/data/RPSR_RPSCSR_UAE.pdf"
    ...
    # Ingest PO T&C PDF
    po_tc_path = "RAG/data/PO_T&C.pdf"
